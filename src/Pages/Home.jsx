        ...
        <Row>
          <Col lg="6">
            <div className="hero__content">
              ...
              <h1>
               Explore New Place's to Create{" "}
                <span className="highlight">Life Long Memories</span>
              </h1>
              <p>
                Discover the joy of exploring new places with Explore With Us—your smart travel companion for unforgettable adventures.
                Whether you're planning a weekend escape or a once-in-a-lifetime journey, our app helps you travel with confidence,
                connect with local guides, and create lifelong memories. Let every trip be a story worth sharing.
              </p>
            </div>
          </Col>
          <Col lg="2">
